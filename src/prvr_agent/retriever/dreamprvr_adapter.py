...
class DreamPRVRAdapter:
    ...
    The adapter keeps DreamPRVR's original clip/frame max-similarity retrieval scores,
    but intentionally does not expose argmax locations. The former peak-seeded agent
    path has been removed; downstream reasoning is prospective and candidate-global.
    """
